...
// 各ボタンのlistener
document.getElementById("image_url_text_box").addEventListener("keypress", function () {
  if(e.which && e.which === 13 || e.keyCode && e.keyCode === 13) {
    addStampFromTextBox();
  }
}, false);

document.getElementById("image_url_add_button").addEventListener("click", function () {
  addStampFromTextBox();
});